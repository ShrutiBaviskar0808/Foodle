...
class _AllFavoriteFoodsScreenState extends State<AllFavoriteFoodsScreen> {
          ...
          return Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(food['restaurant']!, style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                      const SizedBox(height: 4),
                      Row(
                        children: [
                ...
                IconButton(
                  onPressed: () => _toggleFood(food['name']!),
                  icon: Icon(
                        ...
                        child: Column(
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              child: const Text('Add Food', style: TextStyle(color: Colors.white)),
                            ),
                          ],
                        ),
                      ),
